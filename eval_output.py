...
def extract_text_answer(
    ...
    if non_empty_lines:
        ...
        if len(words) > MAX_WORDS_IN_LAST_LINE:
            return ' '.join(words[-MAX_WORDS_IN_LAST_LINE:])
        return last_line
