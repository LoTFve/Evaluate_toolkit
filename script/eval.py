...
def main() -> None:
    ...
    overall_exact_accuracy = correct_count / total_count if total_count > 0 else 0.0
    ...
    output_data: dict[str, Any] = {
        "summary": {
            ...
            "overall_accuracy": overall_exact_accuracy,
    ...
    print(f"总体正确率: {overall_exact_accuracy:.4f} ({overall_exact_accuracy * 100:.2f}%)")
